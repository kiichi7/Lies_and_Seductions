...
public class SetInteger : ConsequenceNode {

	private string variableName;
	private VariableSet variableSet;
	private NumericOperand operand;

	public SetInteger(string variableName, string npcName, NumericOperand operand, Conversation conversation){
	...
	public void Perform(DialogueController dialogueController, GameObject actor){
		variableSet.SetIntegerVariableValue(variableName, (int)operand.GetValue());
	}
}
