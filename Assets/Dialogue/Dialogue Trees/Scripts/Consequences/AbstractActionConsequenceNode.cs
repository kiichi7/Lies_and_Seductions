...
public abstract class AbstractActionConsequenceNode : ConsequenceNode {

	protected GameObject actor;
	private bool afterDialogue;

	public AbstractActionConsequenceNode(GameObject actor, bool afterDialogue){
		this.actor = actor;
