...
public class PCSleepAction : AbstractOneRoundAction, SelectableAction {

	public PCSleepAction(GameObject actor) : base(actor){
		InitInteractionInfo(false, false, false);		
	}
	
	protected override void UpdateOnlyRound(){
		Debug.Log("PCSleepAction.UpdateOnlyRound()");
